...
(function ($) {
    $.extend({
        ...
        table: {
            // 初始化表格参数
            init: function(options, page = true) {
                var defaults = {
                    id: "bootstrap-table",
            ...
            exportUnExpressExcel: function(formId) {
                table.set();
                $.modal.confirm("导出未发货订单会将会修改所有未发货订单，确认吗？", function() {
                    ...
                    $.post(table.options.exportUnExpressUrl, dataParam, function(result) {
